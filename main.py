...
if __name__ =='__main__' : 
    ...
    parser.add_argument('--random_init',type=int,default=False,help='Agent positions are sampled randomly on the grid') 
    ...
    algo = setter.set_algo(args,policy,buffer,env) 
